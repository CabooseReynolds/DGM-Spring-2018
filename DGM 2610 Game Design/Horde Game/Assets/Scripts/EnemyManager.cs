...
namespace Complete
{
    ...
    {
        // This class is to manage various settings on a Enemy.
        // It works with the GameManager class to control how the Enemys behave
        // and whether or not players have control of their Enemy in the 
        // different phases of the game.

        public Color m_PlayerColor;                             // This is the color this Enemy will be tinted.
        public Transform m_SpawnPoint;                          // The position and direction the Enemy will have when it spawns.
        [HideInInspector] public int m_PlayerNumber;            // This specifies which player this the manager for.
        [HideInInspector] public string m_ColoredPlayerText;    // A string that represents the player with their number colored to match their Enemy.
